...
<View style={{backgroundColor:'#000000aa', flex:1}}>
  <StatusBar backgroundColor={'#000000aa'}></StatusBar>


  <TouchableOpacity style={{left:dimension.width*0.90, position:'absolute', marginTop:'5%',  justifyContent:'flex-end', alignItems:'flex-end',
alignSelf:'flex-end'}} onPress={()=> {showmodalOff()}}>
...
<Icon name="cash" color={'#20B3AB'} size={18}/>  
</View>
</View>
<TextInput 
style = {{
...
style={{width:'100%', height:'100%', marginTop:3.5,marginLeft:5, fontSize:16, fontFamily:'Poppins-Medium', fontWeight:'600', color:'#2C358E'}}
/>
</View>
</View>
...
<TouchableOpacity onPress={()=> navigation.navigate('withdraw')} style={{
  backgroundColor:'#20B3AB',
  width:dimension.width*0.70,
  height:dimension.height*0.4,
  borderRadius:300,
  position:'absolute',
  top:dimension.height*0.8,
  left:dimension.width*0.60
}}></TouchableOpacity>
</View>
...
<View  style={{backgroundColor:'#000000aa', flex:1}}>
  ...
  <TouchableOpacity style={{left:dimension.width*0.90, position:'absolute', marginTop:'5%',  justifyContent:'flex-end', alignItems:'flex-end',
alignSelf:'flex-end'}} onPress={()=> {addmodalOff()}}>
  <Icon  name="close-circle" color={'#fff'} size={25}/>
 </TouchableOpacity>
...
<View style={{
  ...
  <Icon2 style={{alignSelf:'center',marginTop:'17%',marginLeft:'4%'}} name="crown" color={'#fff'} size={15}/>
</View>
